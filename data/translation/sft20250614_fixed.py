...
# 3. データセットの準備と前処理
data_file = "translation_data_small.csv"

train_dataset = load_dataset("csv", data_files=data_file)
# データ方向を修正：input=英語, output=日本語 → input=日本語, output=英語
train_dataset = train_dataset["train"].rename_column("output", "japanese_text").rename_column("input", "english_text")
